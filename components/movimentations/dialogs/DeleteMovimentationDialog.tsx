...
export default function DeleteMovimentationDialog({
  movimentation,
  children,
  ...
  return (
    <CustomDialog id="delete-movimentation" title="Excluir movimentação" trigger={children}>
      <div className="flex flex-col gap-2">
        <p>
          Tem certeza que deseja excluir a <strong>movimentação #{movimentation.id}</strong> do
