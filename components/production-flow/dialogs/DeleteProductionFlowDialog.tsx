...
export default function DeleteProductionFlowDialog({
  productionFlow,
  children,
}: DeleteProductionFlowDialogProps) {
  ...
  return (
    <CustomDialog id="delete-production-flow" title="Excluir fluxo de produção" trigger={children}>
