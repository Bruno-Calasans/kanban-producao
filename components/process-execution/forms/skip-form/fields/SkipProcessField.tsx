...
import { defaultSkipProcessFormValues, withForm } from "../skipFormContext";
...
export const SkipProcessField = withForm({
  defaultValues: defaultSkipProcessFormValues,
  props: {} as SkipProcessFieldProps,
