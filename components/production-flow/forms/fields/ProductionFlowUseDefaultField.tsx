    ...
    render({ form }) {
        return <form.Field
            ...
            children={(field) => {
                return (
                    <Field
                        id="use-default-production-flow-field"
                    ...
                    >
                        ...
                        <FieldContent>
                            ...
                            <FieldDescription>
                                Ao marcar esta opção, os produtos cadastrados que não tiverem um fluxo
                                de produção definido, seguirão este fluxo de produção.
                            </FieldDescription>
                        </FieldContent>
                    </Field>
                )
