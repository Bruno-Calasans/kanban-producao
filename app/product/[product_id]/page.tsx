...
import ProductDetailsTabs from "@/components/product-details/tabs/ProductDetailsTabs"
    ...
    return (
        <section>
            ...
            <div className="flex flex-col gap-1 mb-4">
                ...
                <p><strong>Número de OP:</strong> {product.op}</p>
                <p><strong>Fluxo de Produção:</strong> {product.production_flow.name}</p>
            </div>
