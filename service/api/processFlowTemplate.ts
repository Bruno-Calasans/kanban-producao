...
export type CreateProductionFlowTemplateData = Omit<ProductionFlowTemplate, "id" | "created_at" | "updated_at">
...
export async function updateFlowTemplate(flowTemplateId: number, data: UpdateProductionFlowTemplateData) {
    return await supabase
        .from("ProductionFlowTemplate")
        .upsert([
        ])
