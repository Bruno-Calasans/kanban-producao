...
import {
  defaultReprocessFormValues,
  withForm,
  REASON_MAX_LENGTH,
} from "../reprocessExecutionFormContext";
import { FieldError, FieldLabel } from "@/components/ui/field";
import { Input } from "@/components/ui/input";

export const ReprocessReasonField = withForm({
  ...
  render({ form }) {
    return (
      <form.Field
        name="reason"
        children={(field) => {
          const hasDefaultValue = defaultReprocessFormValues[field.name] == field.state.value;
          ...
          return (
            <Field data-invalid={isInvalid}>
              ...
              <Input
                ...
                placeholder="Escreva o motivo do reprocesso (opcional)"
                autoComplete="off"
